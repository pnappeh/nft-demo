...
RING_OWNER_MAPPING = {0: "GANDALF", 1: "NAZGUL", 2: "SAURON"}
RING_OWNER_EXTENSION = {"GANDALF": "jpg", "NAZGUL": "png", "SAURON": "jpeg"}


def get_ring_owner(ring_owner_number):
    return RING_OWNER_MAPPING[ring_owner_number]


def get_ring_owner_extension(ring_owner):
    return RING_OWNER_EXTENSION[ring_owner]
...
def get_contract(contract_name):
    ...
    Args:
        contract_name (string): This is the name of the contract that we will get from
        the config or deploy
